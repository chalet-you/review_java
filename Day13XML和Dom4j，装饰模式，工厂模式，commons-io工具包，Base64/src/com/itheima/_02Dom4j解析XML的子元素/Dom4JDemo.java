...
/**
    ...
    Element元素的API:
        ...
        List<Element> elements(String name):获取当前元素下的指定元素名称的全部子元素（一级）
        Element element(String name):获取当前元素下的指定元素名称的某个子元素，默认取第一个（一级）
 */
public class Dom4JDemo {
    public static void main(String[] args) throws Exception {
        ...
        Document document = saxReader.read(new File("Day13XML和Dom4j，装饰模式，工厂模式，commons-io工具包，Base64/src/books.xml"));

        // 3.获取根元素对象
        Element root = document.getRootElement();
        System.out.println(root.getName());
       // System.out.println(root.getStringValue()); // todo 取该元素 root 的下所有的文本值
        ...
        System.out.println(son1.attributeValue("id"));  // son1.attributeValue(属性名称) ----> 获取该 son1 元素指定的属性名称的值
    }
}

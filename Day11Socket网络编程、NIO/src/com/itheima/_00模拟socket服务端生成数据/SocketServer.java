package com.itheima._00模拟socket服务端生成数据;
...
public class SocketServer {
    ...
    private static List<String> parseFile() {
        ...
        try {
            //1.读取本地源数据
            //本地磁盘路径
            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("E:\\export\\servers\\tmp\\socket\\szse.txt"),"UTF-8"));
            //服务器磁盘路径

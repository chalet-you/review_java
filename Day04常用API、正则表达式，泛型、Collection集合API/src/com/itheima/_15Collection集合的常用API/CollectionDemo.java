...
public class CollectionDemo {
    public static void main(String[] args) {
        ...
        //String[] arrs1 = sets.toArray(String[]::new); // 以后再了解，指定转换的数组类型！这是jdk8以上才可以操作
        //String[] arrs1 = sets.toArray(new String[0]); // 以后再了解，指定转换的数组类型
        // todo 怎么看数组的内容：Arrays.toString(数组)

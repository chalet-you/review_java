package com.itheima._18File类的概述;
...
/**
    ...
    File类的创建文件对象的API:
        ...
        （1）构造器：
            ...
            -- public File(String parent , String child):根据父路径（文件夹）和文件名称获取文件对象！相当于把上面文件路径拆成2段来写
...
public class FileDemo01 {
    public static void main(String[] args) {
        ...
        // 2.创建文件对象：使用相对路径
        File f2 = new File("Day09方法引用, Stream流，File类  , 递归 ，字节流\\src\\dlei01.txt");
        System.out.println(f2.length());

        // 3.创建文件对象：代表文件夹。
        File f3 = new File("F:\\datas\\图片资源\\");

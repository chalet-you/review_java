...
/**
    ...
    Element:
        String elementText(String name这里是子元素的名称): 可以直接获取当前元素的子元素的文本内容
        String elementTextTrim(String name这里是子元素的名称): 去前后空格,直接获取当前元素的子元素的文本内容
        String getText():直接获取当前本元素的文本内容。
        String getTextTrim():去前后空格,直接获取当前本元素的文本内容。
 */

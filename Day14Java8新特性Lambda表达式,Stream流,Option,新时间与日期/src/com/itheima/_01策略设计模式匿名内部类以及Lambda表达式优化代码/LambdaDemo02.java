...
/**
    ...
    缺点：
         需要自己写策略的接口。而且传入的具体实现策略类对象代码臃肿，可读性差
...
public class LambdaDemo02 {
    ...
    @Test
    public void test1(){
        List<Employee> emp1 = filterEmployee(employees, new MyPredicate<Employee>() {
            @Override
        ...
        List<Employee> emp2 = filterEmployee(this.employees, new MyPredicate<Employee>() {
            @Override
            public boolean filter(Employee employee) {

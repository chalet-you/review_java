...
public class ExecDemo {
    public static void main(String[] args)  {
        try(
                // （1）创建一个缓冲字符输入流对象包装字符输入流接通源文件。
                BufferedReader br =
                        new BufferedReader(new FileReader("Day10字符流, 缓冲流、转换流、序列化流，打印流，属性集/src/csb"));
                // （5）创建一个缓冲字符输出流管道通向目标文件。
                BufferedWriter bw = new BufferedWriter(new FileWriter("Day10字符流, 缓冲流、转换流、序列化流，打印流，属性集/src/newcsb"));
                ){

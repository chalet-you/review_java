...
/**
     目标: https://www.baidu.com/s?
          ie=utf-8&
          f=8&
          rsv_bp=1&
          rsv_idx=1&
          tn=baidu&
          wd=%E9%BB%91%E9%A9%AC%E7%A8%8B%E5%BA%8F%E5%91%98&
          rsv_pq=adb2aafb0004cea1&
          rsv_t=bd43rF5NublIew4JRzSmtNoJ2Dtx8lMAuD4NgJOFnkKoA98JL9hZ8DvnSJI&
          rqlang=cn&
          rsv_enter=0&
          rsv_dl=tb
...
public class Base64Demo {
    public static void main(String args[]) {
        try {
            ...
            System.out.println(new String(buffer)); // 黑马程序员

            // 2-1.URL编码
            String rs2 = Base64.getUrlEncoder().encodeToString("?loginName=黑马&passWord=123456".getBytes());
            System.out.println(rs2); // P2xvZ2luTmFtZT3pu5HpqawmcGFzc1dvcmQ9MTIzNDU2
            // 2-2 URL解码
            byte[] buffer2 = Base64.getUrlDecoder().decode(rs2);
            System.out.println(new String(buffer2));  // ?loginName=黑马&passWord=123456

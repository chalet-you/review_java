package com.itheima._12批量插入数据的3种方式;
...
public class BatchInsertTest {
	...
	public void testBatchInsert1() {
		...
		try {
			...
			System.out.println("花费的时间为：" + (end - start));//20000:23628
		} catch (Exception e) {
			e.printStackTrace();
		}finally{
	 ...
	 *   如果有多个参数了： &rewriteBatchedStatements=true
	...
	public void testBatchInsert2() {
		...
		try {
			...
			System.out.println("花费的时间为：" + (end - start));//20000:23628 -- 565
		} catch (Exception e) {								//1000000:7835
			e.printStackTrace();
		}finally{
			JDBCUtils.closeResource(conn, ps);
	...
	public void testBatchInsert3() {
		...
		} catch (Exception e) {								//1000000:7835 -- 6463
			e.printStackTrace();
		}finally{
			JDBCUtils.closeResource(conn, ps);

...
/**
     ...
     小结：
        ...
        覆盖管道：
             Writer fw = new FileWriter("Day10字符流, 缓冲流、转换流、序列化流，打印流，属性集/src/dlei03.txt"); // 覆盖数据管道
        追加数据管道：
             Writer fw = new FileWriter("Day10字符流, 缓冲流、转换流、序列化流，打印流，属性集/src/dlei03.txt",true); // 追加数据管道
        换行：
             fw.write("\r\n"); // 换行
        读写字符文件数据建议使用字符流。
 */

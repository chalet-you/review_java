package com.itheima._15DAO访问数据信息的类和接口.V2_升级版.junit;
...
import com.itheima._15DAO访问数据信息的类和接口.V2_升级版.CustomerDAOImpl;
...
public class CustomerDAOImplTest {
	...
	public void testUpdateConnectionCustomer() {
		...
		try {
			conn = JDBCUtils.getConnection();
			Customer cust = new Customer(18,"贝多芬","beiduofen@126.com",new Date(593425656L));
